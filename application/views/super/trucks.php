        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              ...
              <h4>Daily</h4>
              <span class="text-muted">Daily Active Trucks</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <img data-src="holder.js/150x150/auto/vine" class="img-responsive" alt="Monthly Active Users">
              <h4>Monthly</h4>
              <span class="text-muted">Monthly Active Trucks</span>
            </div>
          </div>
          ...
          <a class="btn btn-primary" href="<?php echo base_url('truck/index'); ?>">Add Truck</a>
          
          <h2 class="sub-header">All Truck Users</h2>
